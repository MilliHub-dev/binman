...
const WASTE_TYPES: Array<{ value: WasteType; label: string; icon: IconName; description?: string }> = [
  { value: 'HOUSEHOLD', label: 'Household', icon: 'waste', description: 'Everyday home waste' },
  { value: 'FOOD', label: 'Food waste', icon: 'food', description: 'Kitchen and food scraps' },
  { value: 'PLASTIC', label: 'Plastic', icon: 'recycle', description: 'Bottles, containers, wrap' },
  { value: 'PAPER', label: 'Paper', icon: 'terms' },
  { value: 'CARDBOARD', label: 'Cardboard', icon: 'parcel' },
  { value: 'GARDEN', label: 'Garden waste', icon: 'leaf', description: 'Leaves, cuttings, branches' },
  { value: 'COMMERCIAL', label: 'Commercial', icon: 'office', description: 'Business or shop waste' },
  { value: 'MIXED', label: 'Mixed waste', icon: 'parcel', description: 'A bit of everything' },
